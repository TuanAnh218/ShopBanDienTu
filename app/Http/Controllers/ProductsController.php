...
class ProductsController extends Controller
{
    	...
    	if ($rq->hasFile('txtdetail_img')) {
    		...
    		foreach ($df as $row) {
    			...
    			if (isset($row)) {
    				...
    				$row->move('public/uploads/products',$name_img);
    				$img_detail->save();
    			}
    		}
		}
    ...
    public function getdel($id)
    {
        ...
        foreach ($detail as $row) {                
               ...
               $pt = public_path('public/uploads/products').$dt->images_url; 
               // dd($pt);   
                if (file_exists($pt))
                {
                    unlink($pt);
