...
@section('content')
                          ...
                          <div id="links">
                            @foreach($data->detail_img as $row)
                              <a href="{!!url('uploads/products/details/'.$row->images_url)!!}" title="{!!$data->name!!}" data-gallery>
                                  <img src="{!!url('public/uploads/products/'.$row->images_url)!!}" alt="{!!$data->name!!}" width="30" height="40">
                              </a>
                            @endforeach                              
                          </div>
                  ...
                  <div class="table-responsive">
                    <div class="panel panel-default">        
                      ...
                      <div id="links">
                        @foreach($data->detail_img as $row)
                          <a href="{!!url('uploads/products/details/'.$row->images_url)!!}" title="{!!$data->name!!}" data-gallery>
                              <img src="{!!url('public/uploads/products/'.$row->images_url)!!}" alt="{!!$data->name!!}"  width="25%" height="120">
                          </a>
                        @endforeach                          
                      </div>
                        <!-- The Bootstrap Image Gallery lightbox, should be a child element of the document body -->
    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        Hãy <a href="#" title="">Like</a> facebook 404 comet
      </div>
    </div> <!-- /fan pages myweb -->        
  </div> 
</div>
